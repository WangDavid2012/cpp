...
* Domain parameters for brainpoolP512r1 (RFC 5639 3.7)
*/
#if defined(POLARSSL_SM2_256_ENABLED)
static const t_uint sm2curve256_p[] = {
	BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
	BYTES_TO_T_UINT_8(0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF),
	BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
	BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF),
};
static const t_uint sm2curve256_a[] = {
	BYTES_TO_T_UINT_8(0xFC, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
	BYTES_TO_T_UINT_8(0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF),
	BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF),
	BYTES_TO_T_UINT_8(0xFF, 0xFF, 0xFF, 0xFF, 0xFE, 0xFF, 0xFF, 0xFF),
};
static const t_uint sm2curve256_b[] = {
...
static const t_uint sm2curve256_gx[] = {
...
static const t_uint sm2curve256_gy[] = {
...
#if defined(POLARSSL_SM2_256_ENABLED)
		case POLARSSL_SM2_256:
			return(LOAD_GROUP_A(sm2curve256));
#endif /* POLARSSL_SM2_256_ENABLED */
